      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex gap-3 mb-4 text-sm">
          <div className="flex flex-col">
            ...
            <span className="font-semibold text-blue-600">{meal.macros.protein}g</span>
          </div>
          <div className="flex flex-col">
            <span className="text-gray-500 text-xs">Carbs</span>
            <span className="font-semibold text-green-600">{meal.macros.carbs}g</span>
          </div>
          <div className="flex flex-col">
            <span className="text-gray-500 text-xs">Fats</span>
            <span className="font-semibold text-yellow-600">{meal.macros.fats}g</span>
          </div>
        </div>
