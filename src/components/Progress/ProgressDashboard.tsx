...
export default function ProgressDashboard({ stats }: ProgressDashboardProps) {
  return (
    <div className="space-y-6">
      ...
      {/* Recent Workouts */}
      <div>
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Recent Workouts</h2>
        {stats.recentWorkouts.length > 0 ? (
          ...
          <Card>
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">Start your fitness journey today!</p>
            </div>
          </Card>
        )}
      </div>
