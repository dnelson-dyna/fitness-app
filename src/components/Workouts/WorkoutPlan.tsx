        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center">
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{workout.estimatedDuration} min</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{workout.caloriesBurned} kcal</p>
            </div>
          </div>
