  ...
  return (
    <div className="space-y-8">
      ...
      {stats.totalWorkouts > 0 && (
        <Card className="bg-gradient-to-r from-primary-50 to-secondary-50">
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <p className="text-3xl font-bold text-gray-900">{stats.totalCaloriesBurned}</p>
              <p className="text-sm text-gray-600 mt-1">Calories</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-gray-900">{Math.round(stats.averageDuration)}</p>
              <p className="text-sm text-gray-600 mt-1">Avg Minutes</p>
            </div>
          </div>
        </Card>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Workouts Card */}
        <Card padding="lg" hover className="border-2 border-transparent hover:border-primary-200">
        ...
        {/* Meal Plans Card */}
        <Card padding="lg" hover className="border-2 border-transparent hover:border-secondary-200">
          <div className="text-center space-y-4">
      ...
      {/* Features */}
      <Card>
        <h3 className="text-xl font-semibold text-gray-900 mb-4">Why Choose FitFlow?</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">Monitor your journey with detailed analytics</p>
          </div>
          <div className="text-center">
            <div className="w-12 h-12 bg-accent-100 rounded-lg flex items-center justify-center mx-auto mb-3">
              <svg className="w-6 h-6 text-accent-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h4 className="font-semibold text-gray-900 mb-1">Stay Motivated</h4>
            <p className="text-sm text-gray-600">Get encouragement and tips along the way</p>
          </div>
        </div>
      </Card>
